...
//         className="bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-md space-y-4 border border-gray-700"
//       >
...
//       {/* Password Reset */}
//       <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-md mt-8 border border-gray-700">
