...
//           <LifeBuoy className="h-10 w-10 text-[#E6A24B] mb-3" />
...
//               className="w-full border border-gray-300 rounded-lg pl-10 pr-4 py-2 text-sm focus:ring-2 focus:ring-[#E6A24B] focus:outline-none"
//             />
...
//             </div>
//             <div>
//               <p className="font-medium">📧 I didn’t receive a verification email. What should I do?</p>
//               <p className="ml-5 text-gray-600">
...
//               <p className="ml-5 text-gray-600">
//                 Navigate to <strong>Settings → Billing</strong> to update your payment
...
//           {/* Email Card */}
//           <div className="bg-white shadow-md rounded-xl p-6 border border-gray-200 flex flex-col items-center text-center">
//             <Mail className="h-8 w-8 text-[#E6A24B] mb-3" />
...
//               className="text-[#E6A24B] font-medium hover:underline"
//             >
...
//           {/* Live Chat Card */}
//           <div className="bg-white shadow-md rounded-xl p-6 border border-gray-200 flex flex-col items-center text-center">
//             <MessageCircle className="h-8 w-8 text-[#E6A24B] mb-3" />
//             <h3 className="font-semibold text-gray-800">Live Chat</h3>
//             <p className="text-sm text-gray-600 mt-1 mb-3">
//               Need quick help? Start a chat with one of our support agents.
//             </p>
//             <button className="bg-[#E6A24B] text-white px-4 py-2 rounded-lg text-sm hover:bg-[#d68d32] transition">
//               Start Chat
//             </button>
//           </div>
//         </div>
...
const SupportPage = () => {
  return (
    <div className="min-h-screen  px-4 py-8 flex justify-center bg-gradient-to-br from-[#B7D4E9] via-white to-[#E6A24B]">
